...
☄️ ───『 **𝙰𝚆𝙰𝙺𝙴𝙽𝙴𝙳 𝙳𝙾𝙼𝙰𝙸𝙽** 』─── ☄️
   ...
   "𝘞𝘢𝘬𝘦 𝘶𝘱 𝘵𝘰 𝘳𝘦𝘢𝘭𝘪𝘵𝘺. 𝘠𝘰𝘶 𝘢𝘳𝘦 𝘸𝘪𝘵𝘯𝘦𝘴𝘴𝘪𝘯𝘨 𝘵𝘩𝘦 𝘣𝘪𝘳𝘵实现了 𝘰𝘧 𝘢 𝘯𝘦𝘸 𝘸𝘰𝘳𝘭𝘥 𝘰𝘳𝘥𝘦𝘳."

👁️ **[ 𝚃𝙷𝙴  𝙼𝙾𝙽𝙰𝚁𝙲𝙷 ]**
├─👤 **Lord:** ${author}
├─🩸 **Bloodline:** Eternal Mangekyō
└─🤖 **Vessel:** MLTN-MD // Perfect Form

💀 **[ 𝚂𝙷𝙰𝙳𝙾𝚆  𝚁𝙴𝙰𝙻𝙼 ]**
├─🔥 **Mana Drive:** Limitless [MAX]
├─⚔️ **Protocol:** Complete Subjugation
└─🌐 **Status:** Monarch Domain Active

  "𝑨𝑹𝑰𝑺𝑬... 𝑲𝒏𝒆𝒆𝒍 𝒃𝒆𝒇𝒐𝒓𝒆 𝒕𝒉𝒆 𝑮𝒉𝒐𝒔𝒕 𝒐𝒇 𝒕𝒉𝒆 𝑼𝒄𝒉𝒊𝒉𝒂."
`;
