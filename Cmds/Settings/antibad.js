...
module.exports = async (context) => {
    ...
    if (!text) {
        return m.reply(
            ...
            "⚔️ *Multi-Assignment Format:* `.setvar ANTILINK = true`\n" +
            "⚔️ *Single-Value Quick-Format:* `.setvar true` _(Automatically maps to GROUP_CONTROL)_"
        );
    }
